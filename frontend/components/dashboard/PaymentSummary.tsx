  ...
  return (
    <div className="rounded-[20px] border border-[#E3E8F0] bg-white p-7 shadow-[0_1px_2px_rgba(16,24,40,0.04),0_2px_8px_rgba(16,24,40,0.04)]">
      ...
      <div className="mt-8 flex items-center gap-8">
        ...
        >
          <div className="flex h-23 w-23 flex-col items-center justify-center rounded-full bg-white text-center">
            <p className="text-base font-bold text-[#0B1F55]">{formatCurrency(total)}</p>
            <p className="mt-0.5 text-[11px] text-[#667085]">Toplam Gelir</p>
          </div>
        </div>
