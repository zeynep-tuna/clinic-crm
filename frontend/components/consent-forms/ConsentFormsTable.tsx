          ...
          <table className="w-full min-w-240 table-fixed text-left">
            <thead>
              <tr className="border-b border-[#EAF0F8]/70 text-xs font-semibold tracking-wide text-[#667085] uppercase">
                ...
                <th className="w-24 pb-2.5 pr-4 font-medium">Dosya</th>
            ...
            <tbody>
              {filteredForms.map((form) => (
                ...
                >
                  ...
                  <td className="truncate py-4 pr-4 text-sm text-[#0B1F55]">{form.formTitle}</td>
                  <td className="py-4 pr-4">
                    <span
                  ...
                  <td className="py-4 pr-4 text-sm text-[#0B1F55]">{form.date}</td>
                  <td className="py-4 pr-4">
                    <span
                  ...
                  <td className="py-4 pr-4">
                    <span className="inline-flex items-center gap-1 rounded-full bg-[#FEE2E2] px-2.5 py-1 text-xs font-medium text-[#EF4444]">
                      <PdfIcon />
                      PDF
                    </span>
                  </td>
