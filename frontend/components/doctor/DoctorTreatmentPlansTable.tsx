...
export default function DoctorTreatmentPlansTable() {
  ...
  return (
    <div className="flex flex-col gap-5">
      <DoctorTreatmentPlanSummaryCards activeFilter={activeFilter} onFilterChange={setActiveFilter} />
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="relative w-full max-w-xs">
            ...
            <input
              ...
              placeholder="Bu listede hasta, tedavi planı veya durum ara..."
            ...
            <tbody>
              {filteredPlans.map((plan) => (
                ...
                >
                  ...
                  <td className="py-4">
                    <span
                      className={`inline-block rounded-full px-3 py-1 text-xs font-semibold ${priorityBadgeClass[plan.priority]}`}
                    >
                      {plan.priority}
                    </span>
                  </td>
