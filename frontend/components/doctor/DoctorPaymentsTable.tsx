...
export default function DoctorPaymentsTable() {
  ...
  return (
    <div className="flex flex-col gap-5">
      <DoctorPaymentSummaryCards payments={payments} activeFilter={activeFilter} onFilterChange={setActiveFilter} />
        ...
        <div className="mt-5 overflow-x-auto">
          {payments.length === 0 && (
            <EmptyState
              ...
              description="Randevularınıza bağlı hasta ödeme kayıtları oluşturulduğunda burada görüntülenir."
            />
          )}
