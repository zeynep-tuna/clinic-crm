...
const initialFormState: SecretaryPatientFormState = {
  fullName: "",
  phone: "",
  email: "",
  birthDate: "",
...
type SecretaryPatientFormErrors = Partial<Record<keyof SecretaryPatientFormState, string>>;

function validateSecretaryPatientForm(values: SecretaryPatientFormState): SecretaryPatientFormErrors {
  const nextErrors: SecretaryPatientFormErrors = {};
...
export default function AddSecretaryPatientModal({ onCreated }: AddSecretaryPatientModalProps) {
  ...
  function updateField<K extends keyof SecretaryPatientFormState>(
    key: K,
    value: SecretaryPatientFormState[K]
  ) {
      ...
      {isOpen && (
        ...
        >
          <div
            role="dialog"
            aria-modal="true"
            aria-labelledby="add-secretary-patient-modal-title"
          ...
          >
            <div className="flex items-start justify-between">
              <div>
                <h2 id="add-secretary-patient-modal-title" className="text-xl font-bold text-[#0B1F55]">
                  Yeni Hasta Ekle
                </h2>
